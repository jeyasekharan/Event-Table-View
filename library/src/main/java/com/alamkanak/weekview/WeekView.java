...
public class WeekView extends View {
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        for (int dayNumber=leftDaysWithGaps+1; dayNumber <= leftDaysWithGaps + mNumberOfVisibleDays + 1; dayNumber++) {
            ...
            canvas.drawText(dayLabel+"there", startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
        ...
        startPixel = startFromPixel;
        for (int dayNumber = 0; dayNumber <  users.length ; dayNumber++) {

                canvas.drawText(users[dayNumber], startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding,  mTodayHeaderTextPaint);
                //canvas.drawText("there", startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
